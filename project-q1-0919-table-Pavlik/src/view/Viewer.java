...
public class Viewer {
   ...
   private void createMenuItemExport(Menu contextMenu) {
		      final MenuItem menuItem = new MenuItem(contextMenu, SWT.PUSH);
		      ...
		      menuItem.addSelectionListener(new SelectionAdapter() {
		         public void widgetSelected(SelectionEvent e) {
		            ...
		            try {
						FileUtil.saveFile("/Users/pav/Library/CloudStorage/iCloud Drive/Desktop/CSCI8710/workspaceCSCI8710/runtime-project-ex-0917-ast-table-Pavlik/project001/output.csv", outLines);
   ...
   private void createProgElemColumns(final Composite parent, final TableViewer viewer) {
      String[] titles = { "Package name", "Class name", "Method Name", "isReturnVoid", "Is Public Method" };
      ...
      col.setLabelProvider(new ColumnLabelProvider() {
         ...
         public String getText(Object element) {
          ...
          @Override
          public Image getImage(Object element) {
             if (((ProgramElement) element).isPublicMethod()) {
                return CHECKED;
             } else {
                return UNCHECKED;
             }
